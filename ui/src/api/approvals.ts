import type { Approval, ApprovalComment, ApprovalLinkedIssueSummary } from "@paperclipai/shared";
...
export const approvalsApi = {
  ...
  listIssues: (id: string) => api.get<ApprovalLinkedIssueSummary[]>(`/approvals/${id}/issues`),
};
