...
def main() -> int:
    ...
    # Validate upstream freshness: check quote_candidates stage outputs
    require_fresh_upstream_stage_outputs(
        manifest,
        "quote_candidates",
    ...
    finalize_stage_outputs(
        manifest_path,
        manifest,
        status_updates={"quote_cards": "ready"},
        target_sections={
            "clip_extractor": {
                "quote_cards_path": str(quote_cards_path),
                "quote_cards_json_path": str(quote_cards_json_path),
            },
        },
        provenance_updates={
            "quote_cards": (
                {
                    "quote_candidates": quote_candidates_path,
                    "clip_candidates": clip_candidates_json_path,
                },
                {
                    "cards_md": quote_cards_path,
