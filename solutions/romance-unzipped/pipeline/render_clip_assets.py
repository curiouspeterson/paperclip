...
from pipeline_common import load_json, save_json, write_text
...
def main() -> int:
    ...
    target["rendered_clips_dir"] = str(rendered_clips_dir)
    target["rendered_clips_path"] = str(rendered_clips_path)
    target["rendered_clips_json_path"] = str(rendered_clips_json_path)
    target["rendered_subtitles_dir"] = str(rendered_subtitles_dir)
    target["audiograms_dir"] = str(audiograms_dir)
    status["rendered_clips"] = "ready"
