...
def parse_args() -> argparse.Namespace:
    ...
    parser.add_argument("--channel-url", default=os.environ.get("RU_YOUTUBE_CHANNEL_URL", DEFAULT_CHANNEL_URL))
    parser.add_argument("--playlist-index", type=int, default=int(os.environ.get("RU_YOUTUBE_PLAYLIST_INDEX", "1")))
    parser.add_argument(
        "--channel-id",
...
def resolve_via_api(channel_id: str, api_key: str, playlist_index: int) -> str:
    channel_url = "https://www.googleapis.com/youtube/v3/channels?" + urlencode(
    ...
    playlist_url = "https://www.googleapis.com/youtube/v3/playlistItems?" + urlencode(
        {
            "part": "contentDetails",
            "playlistId": uploads,
...
def main() -> int:
    ...
    if api_key and channel_id:
        try:
            print(resolve_via_api(channel_id, api_key, args.playlist_index))
            return 0
