...
export function companyService(db: Db) {
  ...
  const companySelection = {
    ...
    voiceDescription: companies.voiceDescription,
    targetAudience: companies.targetAudience,
    defaultChannel: companies.defaultChannel,
    defaultGoal: companies.defaultGoal,
    voiceExamplesRight: companies.voiceExamplesRight,
    voiceExamplesWrong: companies.voiceExamplesWrong,
    mailchimpDefaultListId: companies.mailchimpDefaultListId,
    mailchimpDefaultTemplateId: companies.mailchimpDefaultTemplateId,
    mailchimpDefaultFromName: companies.mailchimpDefaultFromName,
    mailchimpDefaultReplyTo: companies.mailchimpDefaultReplyTo,
    agentDefaultAdapterType: companies.agentDefaultAdapterType,
    agentDefaultProvider: companies.agentDefaultProvider,
    agentDefaultModel: companies.agentDefaultModel,
    agentDefaultHeartbeatIntervalSec: companies.agentDefaultHeartbeatIntervalSec,
    agentDefaultWakeOnDemand: companies.agentDefaultWakeOnDemand,
    agentDefaultCooldownSec: companies.agentDefaultCooldownSec,
    agentDefaultMaxConcurrentRuns: companies.agentDefaultMaxConcurrentRuns,
    agentDefaultMaxTurnsPerRun: companies.agentDefaultMaxTurnsPerRun,
    agentDefaultBrowserAutomationProvider: companies.agentDefaultBrowserAutomationProvider,
    agentDefaultHermesManagedHome: companies.agentDefaultHermesManagedHome,
    agentDefaultHermesSeedCompanyProfileMemory: companies.agentDefaultHermesSeedCompanyProfileMemory,
    agentDefaultHermesToolsets: companies.agentDefaultHermesToolsets,
    agentDefaultHermesAllowedMcpServers: companies.agentDefaultHermesAllowedMcpServers,
    agentDefaultHermesMcpServers: companies.agentDefaultHermesMcpServers,
    agentDefaultDangerouslySkipPermissions: companies.agentDefaultDangerouslySkipPermissions,
    agentDefaultDangerouslyBypassSandbox: companies.agentDefaultDangerouslyBypassSandbox,
